...
Hunter's September 19 direction removes the career-title list. Keep the company stories in reverse chronological order: Presage Technologies, Owner.com, Sendoso, Calendly, Salesloft, Silverpop. Presage is current; show Hunter's hands-on product work there (customer discovery, shaping direction, delivery with engineering), with the Brown research partnership as a customer-impact example. Per his September 23 correction, do not claim he leads or owns Presage's product organization. Show the customer problem, Hunter's judgment and ownership, and the result. Give distinct results their own subsections rather than burying them under "I also." Preserve old inbound anchors without restoring the visible career history.
